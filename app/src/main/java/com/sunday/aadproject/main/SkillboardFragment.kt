...
class SkillboardFragment(private val apiService: LeaderSkillService, private val progressBar: ProgressBar): Fragment(R.layout.fragment_skillboard), SwipeRefreshLayout.OnRefreshListener {
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        skillSwipeToRefresh?.setOnRefreshListener(this)
        activity?.apply{
